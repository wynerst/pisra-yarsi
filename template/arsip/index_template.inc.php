...
<div class="container_12">
    ...
    <div class="grid_12 tabs" id="main-menu">
        <ul id="primary-links">
            ...
            <li><a class="menu" href="index.php?p=libinfo"><span><?php echo __('Archive Unit Information'); ?></span></a></li>
			<li><a class="menu" href="index.php?p=member"><span><?php echo __('Staff Area'); ?></span></a></li>
            <li><a class="menu" href="index.php?p=help"><span><?php echo __('Help on Search'); ?></span></a></li>
            <li><a class="menu" href="index.php?p=login"><span><?php echo __('Administrator'); ?></span></a></li>
<!-- 
...
-->
    ...
    <div class="grid_2" id="side-menu">
        ...
        <!-- license -->
            ...
            <p>
            Part of This Software is Released Under <a href="http://www.gnu.org/copyleft/gpl.html" title="GNU GPL License" target="_blank">GNU GPL License</a>
            </p>
        <!-- license end -->
