...
// page title
$page_title = $sysconf['library_name'].' :: Archive storage and retrieval system';
// main menu
$module = new module();
...
ob_start();
// info
$info = __('Welcome To The Archive storage and retrieval system, you are currently logged in as').' <strong>'.$_SESSION['realname'].'</strong>'; //mfc
